 ...
 */
class CouponDatabase(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    private val SQL_CREATE_ENTRIES = "CREATE TABLE ${CouponEntry.TABLE_NAME} (" +
    ...
    private val SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS ${CouponEntry.TABLE_NAME}"
